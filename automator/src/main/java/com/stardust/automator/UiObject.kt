...
open class UiObject(
    ...
    fun setSelection(s: Int, e: Int): Boolean {
        return performAction(
            AccessibilityNodeInfoCompat.ACTION_SET_SELECTION, ActionArgument.IntActionArgument(
                AccessibilityNodeInfoCompat.ACTION_ARGUMENT_SELECTION_START_INT, s
            ), ActionArgument.IntActionArgument(
                AccessibilityNodeInfoCompat.ACTION_ARGUMENT_SELECTION_END_INT, e
            )
        )
    }
    ...
    fun setText(text: String): Boolean {
        return performAction(
            AccessibilityNodeInfoCompat.ACTION_SET_TEXT, ActionArgument.CharSequenceActionArgument(
                AccessibilityNodeInfoCompat.ACTION_ARGUMENT_SET_TEXT_CHARSEQUENCE, text
            )
        )
    }
    ...
    fun setProgress(value: Float): Boolean {
        return performAction(
            ACTION_SET_PROGRESS.id, ActionArgument.FloatActionArgument(
                AccessibilityNodeInfoCompat.ACTION_ARGUMENT_PROGRESS_VALUE, value
            )
        )
    }
    ...
    fun scrollTo(row: Int, column: Int): Boolean {
        return performAction(
            ACTION_SCROLL_TO_POSITION.id, ActionArgument.IntActionArgument(
                AccessibilityNodeInfoCompat.ACTION_ARGUMENT_ROW_INT, row
            ), ActionArgument.IntActionArgument(
                AccessibilityNodeInfoCompat.ACTION_ARGUMENT_COLUMN_INT, column
            )
        )
    }
    ...
    companion object {
        ...
        fun createRoot(
            root: AccessibilityNodeInfo, allocator: AccessibilityNodeInfoAllocator?
        ): UiObject {
