package cn.com.auto.thkl.timing
...
import cn.com.auto.thkl.ScriptIntents
import cn.com.auto.thkl.storage.database.BaseModel
...
class TimedTask : BaseModel {
    ...
    constructor(millis: Long, timeFlag: Long, scriptPath: String?,config: ExecutionConfig,script:String) {
        this.millis = millis
        this.timeFlag = timeFlag
        this.scriptPath = scriptPath
        delay = config.delay
    ...
    fun createIntent(): Intent {
        return Intent(TaskReceiver.ACTION_TASK)
            ...
            .putExtra(ScriptIntents.EXTRA_KEY_PRE_EXECUTE_SCRIPT,script)
