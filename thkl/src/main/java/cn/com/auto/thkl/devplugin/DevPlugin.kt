package cn.com.auto.thkl.devplugin
...
import cn.com.auto.thkl.devplugin.message.Hello
import cn.com.auto.thkl.devplugin.message.HelloResponse
import cn.com.auto.thkl.devplugin.message.LogData
import cn.com.auto.thkl.devplugin.message.Message
import java.io.File
...
object DevPlugin {
    ...
    suspend fun newConnection(session: WebSocketSession, serverUrl: String? = null) {
        ...
        DevPlugin.connection = connection
        connection.init()
    }
