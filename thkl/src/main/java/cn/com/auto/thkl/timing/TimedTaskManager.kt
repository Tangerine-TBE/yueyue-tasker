...
import cn.com.auto.thkl.App.Companion.app
import cn.com.auto.thkl.storage.database.IntentTaskDatabase
import cn.com.auto.thkl.storage.database.ModelChange
import cn.com.auto.thkl.storage.database.TimedTaskDatabase
import cn.com.auto.thkl.timing.IntentTask
import cn.com.auto.thkl.timing.TimedTask
import cn.com.auto.thkl.utils.Observers
...
object TimedTaskManager {
    ...
    @SuppressLint("CheckResult")
    fun addTask(timedTask: TimedTask, listener:ScriptExecutionListener){
        timedTaskDatabase.insert(timedTask)
            .subscribe({
                id:Long? ->timedTask.id = id!!
                getWorkProvider(context).scheduleTaskIfNeeded(context,timedTask,false,listener)
            }){obj:Throwable-> obj.printStackTrace()}
    }
